...
path_general_microstates = os.path.join(".", "csvs")
...
print("Tiempo de ejecución en segundos:", tiempo_segundos)
print("Tiempo de ejecución en minutos:", tiempo_minutos)
print("Tiempo de ejecución en horas:", tiempo_horas)